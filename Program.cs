...
namespace LINQBeginner
{
    class Program
    {
        ...
        private static void FirstOrDefaultClause()
        {
            //FIRST OR DEFAULT
        ...
        private static void FirstClause()
        {
        ...
        private static void SkipClause()
        {
            //SKIP
        ...
        private static void TakeClause()
        {
            //TAKE
        ...
        private static void ThenClause()
        {
        ...
        private static void OrderByDesc()
        {
            //ORDER BY DESCENDING
        ...
        private static void OrderByAsc()
        {
            //ORDER BY ASCENDING
